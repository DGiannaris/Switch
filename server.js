             ...
             if ( !( data.match( /^[a-zA-Z0-9][\w]{3,24}$/ ) ) ) {
                ChannelParams = 'invalid user'
                 ...
                 request( options, ( err, res, body ) => {
                     ...
                     //trying similar names
                     //going for one more request from api to get an array of similarly named channels
                    
                  let options = {
                     url: 'https://api.twitch.tv/kraken/search/channels?query=' +data,
                     method: 'GET',
                     form: '',  
                     headers: {
                         'Client-ID': 'p5d4th8o23p7t21fr6hp4gu1n3d2jc',
                 ...
                 request( options, ( err, res, body ) => {
                     ...
                     for ( var l = 0; l <= result3.channels.length - 1; l++ ) {                           
                           similar.push(result3.channels[l].display_name)
                     }
